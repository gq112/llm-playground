"""
vLLM + SGLang Observability - a focused dashboard for inference-server Prometheus metrics
"""

__version__ = "0.1.8"
__author__ = "micytao"
__description__ = "A focused observability dashboard for vLLM and SGLang Prometheus metrics"
...
def run(host: str = "0.0.0.0", port: int = 7860, reload: bool = False):
    """
    Run the vLLM and SGLang observability dashboard.
